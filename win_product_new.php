<div class="modal fade" id="win_product_new" data-keyboard="false" data-backdrop="static" tabindex="-1">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class='row'>
					<div class='col-md-8'>
						...
						<input type='text' id='txt_product_code' class='form-control txt-product' />
					</div>
					<div class='col-md-4'>
						<label style='margin-top: 0.5em;font-weight: normal;'>Category <span style='color:red'>*</span></label>
						<select id='txt_product_category' class='form-control txt-product'>
				...
				<div class='row'>
					<div class='col-md-8'>
						...
						<input type='text' id='txt_product_name' class='form-control txt-product' />
					</div>
					<div class='col-md-4'>
						<label style='margin-top: 0.5em;font-weight: normal;'>UOM <span style='color:red'>*</span></label>
						<select id='txt_product_uom' class='form-control txt-product'>
			...
			<div class="modal-footer">
				<div class="buttons_show pull-right">
					<button type="button" id="btn_product_save" class="btn btn-success"><span class='fa fa-check'></span> Save </button>
