...
$objPHPExcel->setActiveSheetIndex(0)
			...
			->setCellValue('C6', 'PRODUCT NAME')
            ->setCellValue('D6', 'QTY')
            ->setCellValue('E6', 'UOM')
			->setCellValue('F6', 'BUYER TYPE')
			->setCellValue('G6', 'PRICE')
            
			/*
			->setCellValue('I6', 'DISCOUNT TYPE')
            ->setCellValue('J6', 'DISCOUNT VALUE')
			->setCellValue('K6', 'DISCOUNT TOTAL')
            */
			
            ->setCellValue('H6', 'TOTAL')
			->setCellValue('I6', 'TAXBASE')
			->setCellValue('J6', 'GST')
...
$objPHPExcel->getActiveSheet()->getStyle('A6:K6')
            ->getAlignment()->setWrapText(true); 
            
$objPHPExcel->getActiveSheet()->getStyle('A6:K6')->getAlignment()
...
$objPHPExcel->getActiveSheet()->getStyle('H6:H6')->getFont()->getColor()->setARGB(PHPExcel_Style_Color::COLOR_RED);
			...
			if ($count > 0){
                ...
                while($row=$pop->fetch_object()){
					...
					$objPHPExcel->setActiveSheetIndex(0)
									...
									->setCellValue('E'.$i, $uom)
									->setCellValue('F'.$i, $buyer_type)
									->setCellValue('G'.$i, $price)
									
									/*
									->setCellValue('I'.$i, $discount_type_word)
									->setCellValue('J'.$i, $discount_qty)
									->setCellValue('K'.$i, $discount_total)
									*/
									
									->setCellValue('H'.$i, $total)
									->setCellValue('I'.$i, $taxbase)
									->setCellValue('J'.$i, $gst)
						...
						$objPHPExcel->getActiveSheet()->getStyle('H' . $i . ':J' . $i)->getAlignment()
                                    ->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER)
						...
						*/
                        ...
                        $objPHPExcel->getActiveSheet()->getStyle('H' . $i . ':H' . $i)->getFont()->getColor()->setARGB(PHPExcel_Style_Color::COLOR_RED);
				...
				$objPHPExcel->setActiveSheetIndex(0)
									...
									->setCellValue('D'.$i, $total_qty)																	
									->setCellValue('H'.$i, $total_total)
									->setCellValue('I'.$i, $total_taxbase)
									->setCellValue('J'.$i, $total_gst)									
									;
