    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class='row'>
                    <div class='col-md-4'>
                        <label style='margin-top: 0.5em; font-weight: normal;'>Quantity <span
                                style='color:red'>*</span></label>
                        <div class="input-group">
                            <input type='text' id='txt_receiving_qty_update' placeholder='0.00'
                    ...
                    <div class='col-md-4'>
                        ...
                        <div class="input-group">
                            <input type='text' id='txt_receiving_price_update' placeholder='0.00'
                                class='form-control text-right txt-receiving numeric' />
                        </div>
                    </div>
                    <div class='col-md-4'>
                        ...
                        <div class="input-group">
                            <input type='text' id='txt_receiving_total_update' placeholder='0.00'
                ...
                <div class="row">
                    <div class='col-md-12'>
                        <label style='margin-top: 0.5em;font-weight: normal;'>Supplier <span
                                style='color:red'>*</span></label>
            ...
            <div class="modal-footer">
                <div class="buttons_show pull-right">
                    <button type="button" id="btn_receiving_save_update" class="btn btn-success"><span
