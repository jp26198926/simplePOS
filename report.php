...
<body>
        ...
        <div class="container-fluid">
          <div class="navbar-collapse collapse in">
            ...
            <ul class="nav navbar-nav navbar-left">
              <li class="navbar-title"><span class='fa fa-bar-chart fa-2x'></span><span class="highlight" style='margin-left: 0.5em;'> REPORT</span></li>
                      ...
                      <div role="tabpanel" class="tab-pane active" id="transaction">
                        <div class="card">
                          ...
                          <div class="card-body no-padding" style="overflow-x: scroll;">
                            <table id="tbl_transaction_list" class="tbl_transaction_list table table-bordered table-hover table-striped" cellspacing="0" width="100%" style="font: 90% Trebuchet MS; ">
                              <thead>
                                <tr>
                                  <th>Option</th>
                                  <th>Receipt No.</th>
                      ...
                      <div role="tabpanel" class="tab-pane" id="sale">
                        <div class="card">
                          <div class="card-body no-padding" style='overflow: scroll;'>
                            <table id="tbl_sales_list" class="table table-sm table-bordered table-hover table-striped" cellspacing="0" width="100%" style="font: 90% Trebuchet MS; ">
                              <thead>
                                <tr>
                                  <th>Date</th>
                                  <th>Receipt #</th>
                      ...
                      <div role="tabpanel" class="tab-pane" id="summary">
                        <div class='row'>
                          ...
                          <div class="col-md-6" style='margin-bottom:0.5em;'>
                            Date Range: <i id='summary_search_dtfrom'><?php echo date('Y-m-d'); ?></i> &nbsp; to &nbsp; <i id='summary_search_dtto'><?php echo date('Y-m-d');  ?></i>
                          </div>
                        </div>

                        <div class="card">
                          <div class="card-body no-padding" style='overflow: scroll;'>
                            <table id="tbl_sales_summary_list" class="table table-sm table-bordered table-hover table-striped" cellspacing="0" width="100%" style="font: 90% Trebuchet MS; ">
                        ...
                        <div class="card">
                          <div class="card-body no-padding" style='overflow: scroll;'>
                            <div class="col-sm-4">
                              ...
                              <input type='text' id="txt_inventory_search" class="form-control text-center" readonly />
                            </div>
                            <div class="col-sm-4">
                              <label>Ending Date</label>
                              <input type='text' id="txt_inventory_ending" class="form-control text-center" readonly />
                            </div>

                            <table id="tbl_inventory_list" class="table table-sm table-bordered table-hover table-striped" cellspacing="0" width="100%" style="font: 90% Trebuchet MS; ">
                              <thead>
                                <tr>
                                  <th>Product Code</th>
                                  <th>Product Name</th>
                              ...
                              <tbody>
                                <tr>
                                  <td colspan="5" align="center">Use Advance Search</td>
                              </tbody>
                            </table>
                          </div>
                        </div>
  ...
  <script>
    ...
    $(document).on("click", ".btn_report_excel", function(e) {
      ...
      switch (parseInt(tab_report)) {
        ...
        case 4:
          ...
          window.location.assign("excel_report_inventory.php?product=" + product_searched + "&ending=" + date_ending);
          break;
    ...
    $(document).on("click", ".btn_report_print", function(e) {
      ...
      switch (parseInt(tab_report)) {
        ...
        case 4: //print inventory
          var product_searched = $("#txt_inventory_search").val();
          var date_ending = $("#txt_inventory_ending").val();
          window.location.assign("print_report_inventory.php?product=" + product_searched + "&ending=" + date_ending);
          break;
      ...
      if (id) {
        ...
        $.post("db_transaction.php", {
          ...
          if (data.indexOf("<!DOCTYPE html>") > -1) {
            ...
            txt += "<table id='transaction_cancelled_item' class='table-striped table-bordered table-hover' style='font-size:1em; width:100%'>"
            txt += "<label>Items</label>";
            txt += "<thead><tr><th>#</th> <th align='center'>QTY</th> <th align='center'>Item</th> <th align='center'>Price</th> <th align='center'>Discount</th> <th align='center'>Total</th> </tr></thead>";
    ...
    $(document).on('click', '.btn_transaction_recomplete', function(e) {
      ...
      txt += "  <strong><i class='fa fa-exclamation-triangle fa-2x'></i></strong> Are you sure you want to MARK AS COMPLETED this transaction?";
      txt += "</div>";
            ...
            if (result) {
              $.post("db_transaction.php", {
                ...
                if (data.indexOf("<!DOCTYPE html>") > -1) {
                  ...
                  $("#tbl_transaction_list tbody " + tr_id).html(data).removeClass('danger');
          ...
          if (qty > 0) {
            ...
            $.post("db_receiving.php", {
              ...
              if (data.indexOf("<!DOCTYPE html>") > -1) {
                ...
                $(".success_msg").text("Successfully Saved! " + qty + " " + uom + " " + product_name);
    ...
    $(document).on('click', '.btn_receiving_confirm', function(e) {
      ...
      var txt = "<div class='alert alert-warning role='alert'>";
      txt += "  <strong><i class='fa fa-exclamation-triangle fa-2x'></i></strong> Are you sure you want to RE-CONFIRM this transaction?";
      txt += "</div>";
            ...
            if (result) {
              ...
              $.post("db_receiving.php", {
                ...
                if (data.indexOf("<!DOCTYPE html>") > -1) {
                  ...
                  $("#tbl_receiving_list tbody #" + tr_id).removeClass('danger');
      ...
      if (id) {
        ...
        $.post("db_receiving.php", {
          ...
          if (data.indexOf("<!DOCTYPE html>") > -1) {
            ...
            var product = qty + " " + uom + " <b>" + product_code + " - " + product_name + "</b>";
    ...
    $(document).on('click', '.btn_product_activate', function(e) {
      ...
      var txt = "<div class='alert alert-warning role='alert'>";
      txt += "  <strong><i class='fa fa-exclamation-triangle fa-2x'></i></strong> Are you sure you want to ACTIVATE this product?";
      txt += "</div>";
    ...
    $(document).on('click', '.btn_product_delete', function(e) {
      ...
      var txt = "<div class='alert alert-warning role='alert'>";
      txt += "  <strong><i class='fa fa-exclamation-triangle fa-2x'></i></strong> Are you sure you want to REMOVE this product?";
      txt += "</div>";
