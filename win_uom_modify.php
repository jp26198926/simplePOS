<div class="modal fade" id="win_uom_modify" data-keyboard="false" data-backdrop="static" tabindex="-1"  >
    <div class="modal-dialog" >
        <div class="modal-content">
            <div class="modal-header">				
				<h4 class="modal-title" style='font-weight: bold;'>
					<span class='fa fa-random fa-fw'> </span>
					Modify Unit of Measurement (UOM)
				</h4>
            ...
            <div class="modal-body">
				<div class='row'>
					<div class='col-md-4'>
						...
						<input type='text' id='txt_uom_abbrevation_update' placeholder='Ex: kg, pc, etc..' class='txt-uom-update txt-upper form-control' />
					</div>
					<div class='col-md-8'>
						<label style='margin-top: 0.5em;font-weight: normal;'>Description  <span style='color:red'>*</span></label>
						<input type='text' id='txt_uom_description_update' placeholder='Ex: Kilogram, Piece, etc..' class='txt-uom-update form-control' />
					</div>
				</div>				
            </div>
			<div class="modal-footer">
				<div class="buttons_show pull-right">
					<button type="button" id="btn_uom_save_update" class="btn btn-success" ><span class='fa fa-check'></span> Update </button>
