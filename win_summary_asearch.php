<div class="modal fade" id="win_summary_asearch" data-keyboard="false" data-backdrop="static" tabindex="-1"  >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
				<div class='row'>					
					<div class='col-md-12'>
						...
						<input type='text' id='txt_summary_asearch_product' placeholder="Code or Name" class='form-control txt-summary-asearch'  />
					</div>
				</div>	
				<div class='row'>
					<div class='col-md-6'>
						<label style='margin-top: 0.5em; font-weight: normal;'>Date From</label>
						<input type='text' id='txt_summary_asearch_dtfrom'  class='datepicker form-control txt-summary-asearch' readonly />
					</div>
					<div class='col-md-6'>
						<label style='margin-top: 0.5em; font-weight: normal;'>Date To</label>
						<input type='text' id='txt_summary_asearch_dtto'  class='datepicker form-control txt-summary-asearch' readonly />
					</div>
			...
			<div class="modal-footer">
				<div class="buttons_show pull-right">
					<button type="button" id="btn_summary_asearch" class="btn btn-success" ><span class='fa fa-search'></span> Search </button>
