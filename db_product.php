...
switch ($action) {
    case 1: //search
        ...
        $sql .= " WHERE concat_ws(' ',p.product_code,p.product_name,u.uom,c.category, u.description,s.status) 
                     LIKE '%{$mysearch}%' ORDER BY p.product_name;";
    ...
    case 2: //add new
        ...
        if ($product_code && $product_name && $product_uom && $product_category) {
            ...
            $sql = "INSERT INTO pos_product (product_code, product_name, product_uom, category_id)
                        VALUES ('{$product_code}','{$product_name}',$product_uom, $product_category);";
    ...
    case 4: //get info
        $id = $_POST['id'];
        if ($id) {
            $sql = "SELECT product_code,product_name,product_uom,category_id FROM pos_product WHERE id={$id};";
            ...
            if ($exec) {
                ...
                echo $product_code . ":|:" . $product_name . ":|:" . $product_uom . ":|:" . $product_category;
            } else {
                echo "Error: " . $mysqli->error;
            }
        } else {
    ...
    case 6: //advance search
        ...
        if ($product_category) {
            $sql .= " AND p.category_id={$product_category} ";
        }
        /*
            if ($product_price){
    ...
    case 8: //get info for price
        ...
        if ($id) {
            ...
            if ($exec) {
                ...
                echo $product_code . ":|:" . $product_name . ":|:" . $price . ":|:" . $product_uom . ":|:" . $product_category;
            } else {
                echo "Error: " . $mysqli->error;
            }
        } else {
