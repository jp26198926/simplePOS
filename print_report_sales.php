        ...
        */
        ...
        $tbl_list = "   <table cellspacing=\"0\" cellpadding=\"1\" border=\"1\" >
                            <tr align=\"center\" >                                
                                ...
                                <!--
                                <th  rowspan=\"1\" width=\"10%\" ><b>PRODUCT CODE</b></th>
                                ...
                                <th  rowspan=\"1\" width=\"15%\" ><b>BUYER TYPE</b></th>
                                <th  rowspan=\"1\" width=\"5%\" ><b>PRICE</b></th>
                                
                                <!--
                                <th  colspan=\"3\" width=\"25%\" ><b>DISCOUNT</b></th>
                                -->
            ...
            if ($pop){
                ...
                if ($count > 0){
                    ...
                    //grand total
                    $tbl_list .=  "<tr align=\"center\" >";                              
                    $tbl_list .=  "  <th colspan=\"3\" align=\"left\" ><b>GRAND TOTAL</b></th>";                  
                    $tbl_list .=  "  <th align=\"right\" ><b>" . number_format($total_qty,2,'.',',') . "</b></th>";
                    $tbl_list .=  "  <th colspan=\"3\" ></th>";
                    ...
                    $tbl_list .= "<tr><td colspan=\"10\">No Record</td></tr>";
                }
            }else{
                $tbl_list .= "<tr><td colspan=\"10\">" . $mysqli->error . "</td></tr>";
            }
