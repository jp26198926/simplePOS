...
<body>
        ...
        <div class="container-fluid">
          <div class="navbar-collapse collapse in">
            ...
            <ul class="nav navbar-nav navbar-left">
              <li class="navbar-title"><span class='fa fa-cubes fa-2x'></span><span class="highlight" style='margin-left: 0.5em;'> DATA MANAGEMENT</span></li>
                ...
                <div class="section-body">
                  ...
                  <div role="tabpanel">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                      <li id="1" role="presentation" class="tab_product active"><a href="#product" aria-controls="product" role="tab" data-toggle="tab"><i class='fa fa-cube fa-fw'></i>Product</a></li>
                    ...
                    <div class="tab-content">
                      <div role="tabpanel" class="tab-pane active" id="product">
                        <div class="card">
                          ...
                          <div class="card-body no-padding">
                            <table id="tbl_product_list" class="tbl_product_list table table-bordered table-hover table-striped" cellspacing="0" width="100%" style="font: 90% Trebuchet MS; ">
                              <thead>
                                <tr>
                                  <th>Option</th>
                                  <th>Product Code</th>
                      ...
                      <div role="tabpanel" class="tab-pane" id="receiving">
                        <div class="card">
                          <div class="card-body no-padding">
                            <table id="tbl_receiving_list" class="table table-sm table-bordered table-hover table-striped" cellspacing="0" width="100%" style="font: 90% Trebuchet MS; ">
                              <thead>
                                <tr>
                                  <th>Option</th>
                                  <th>Date</th>
                      ...
                      <div role="tabpanel" class="tab-pane" id="uom">
                        <div class="card">
                          <div class="card-body no-padding">
                            <table id="tbl_uom_list" class="table table-bordered table-hover table-striped" cellspacing="0" width="100%" style="font: 90% Trebuchet MS; ">
                              <thead>
                                <tr>
                                  <th>Option</th>
                                  <th>Abbrevation</th>
                      ...
                      <div role="tabpanel" class="tab-pane" id="supplier">
                        <div class="card">
                          <div class="card-body no-padding">
                            <table id="tbl_supplier_list" class="table table-bordered table-hover table-striped" cellspacing="0" width="100%" style="font: 90% Trebuchet MS !important; ">
                              <thead>
                                <tr>
                                  <th>Option</th>
                                  <th>Supplier Name</th>
                      ...
                      <div role="tabpanel" class="tab-pane" id="buyer">
                        <div class="card">
                          <div class="card-body no-padding">
                            <table id="tbl_buyer_list" class="table table-bordered table-hover table-striped" cellspacing="0" width="100%" style="font: 90% Trebuchet MS !important; ">
                              <thead>
                                <tr>
                                  <th>Option</th>
                                  <th>Buyer Type</th>
                      ...
                      <div role="tabpanel" class="tab-pane" id="price">
                        <div class="card">
                          <div class="card-body no-padding">
                            <table id="tbl_price_list" class="table table-bordered table-hover table-striped" cellspacing="0" width="100%" style="font: 90% Trebuchet MS !important; ">
                              <?php
                              echo "<thead>";
  ...
  <script>
    ...
    $(document).on('click', '.btn_buyer_activate', function(e) {
      ...
      var txt = "<div class='alert alert-warning role='alert'>";
      txt += "  <strong><i class='fa fa-exclamation-triangle fa-2x'></i></strong> Are you sure you want to ACTIVATE this buyer?";
      txt += "</div>";
            ...
            if (result) {
              ...
              $.post("db_buyer.php", {
                ...
                if (data.indexOf("<!DOCTYPE html>") > -1) {
                  ...
                  $("#tbl_buyer_list tbody #" + tr_id).html(data).removeClass('danger');
    ...
    $(document).on('click', '.btn_buyer_delete', function(e) {
      ...
      var txt = "<div class='alert alert-warning role='alert'>";
      txt += "  <strong><i class='fa fa-exclamation-triangle fa-2x'></i></strong> Are you sure you want to MARK as Inactive this buyer type?";
      txt += "</div>";
            ...
            if (result) {
              ...
              $.post("db_buyer.php", {
                ...
                if (data.indexOf("<!DOCTYPE html>") > -1) {
                  ...
                  $("#tbl_buyer_list tbody #" + tr_id).html(data).addClass('danger');
