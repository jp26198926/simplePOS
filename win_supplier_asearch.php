<div class="modal fade" id="win_supplier_asearch" data-keyboard="false" data-backdrop="static" tabindex="-1"  >
    <div class="modal-dialog modal-lg" >
        <div class="modal-content">
            ...
            <div class="modal-body">
				<div class='row'>
					<div class='col-md-6'>
						<label style='margin-top: 0.5em; font-weight: normal;'>Supplier Name</label>
						<input type='text' id='txt_supplier_name_asearch'  class='txt-supplier-asearch form-control' />
					</div>
					<div class='col-md-6'>
						<label style='margin-top: 0.5em;font-weight: normal;'>Description</label>
						<input type='text' id='txt_supplier_description_asearch'  class='txt-supplier-asearch form-control' />
					</div>
				</div>				
            </div>
			<div class="modal-footer">
				<div class="buttons_show pull-right">
					<button type="button" id="btn_supplier_asearch" class="btn btn-success" ><span class='fa fa-search'></span> Search </button>
