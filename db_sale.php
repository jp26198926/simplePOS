    ...
    switch($action){
        ...
        case 9: //save sale            
            ...
            if ($amount_due > 0.001 && $cash >= $amount_due){
                //save tran
                $sql = "INSERT INTO pos_transaction (dt,subtotal,discount_total,discount_type,discount_qty,total,tran_cash,tran_change,user_id,remarks)
                        VALUES ('{$dt}',{$subtotal},{$discount},{$discount_type},{$discount_qty},{$amount_due},{$cash},{$change},{$uid},'{$remarks}');";
