<div class="modal fade" id="win_category_asearch" data-keyboard="false" data-backdrop="static" tabindex="-1">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class='row'>
					<div class='col-md-6'>
						...
						<input type='text' id='txt_category_asearch' class='txt-category-asearch form-control' />
					</div>
					<div class='col-md-6'>
						<label style='margin-top: 0.5em;font-weight: normal;'>Status</label>
						<select id='txt_category_status_asearch' class='txt-category-asearch form-control'>
							<option value=''> -- All --</option>
							<?php
							include('connect.php');

							$sql = "SELECT * FROM pos_category_status ORDER BY status;";
			...
			<div class="modal-footer">
				<div class="buttons_show pull-right">
					<button type="button" id="btn_category_asearch" class="btn btn-success"><span class='fa fa-search'></span> Search </button>
