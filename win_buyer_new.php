<div class="modal fade" id="win_buyer_new" data-keyboard="false" data-backdrop="static" tabindex="-1"  >
            ...
            <div class="modal-body">
				<div class='row'>
					<div class='col-md-12'>
						...
						<input type='text' id='txt_buyer_type'  class='txt-buyer form-control' />
					</div>
				</div>				
            </div>
			<div class="modal-footer">
				<div class="buttons_show pull-right">
					<button type="button" id="btn_buyer_save" class="btn btn-success" ><span class='fa fa-check'></span> Save </button>
