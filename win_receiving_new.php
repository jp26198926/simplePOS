        ...
        <div class="modal-content">
				...
				<div class='row'>
					<div class='col-md-6'>
						...
						<div class="input-group">
							<input type='text' id='txt_receiving_qty' placeholder='0.00' class='form-control text-right txt-receiving numeric' />
							<span class="input-group-addon"><span id='txt_receiving_uom'></span></span>							
						</div>
			...
			<div class="modal-footer">
				<div class="buttons_show pull-right">
					<button type="button" id="btn_receiving_save" class="btn btn-success" ><span class='fa fa-check'></span> Save </button>
