        ...
        <div class="container-fluid">
          <div class="navbar-collapse collapse in">
            ...
            <ul class="nav navbar-nav navbar-left">
              <li class="navbar-title"><span class='fa fa-group fa-2x'></span><span class="highlight" style='margin-left: 0.5em;'> DEPARTMENT</span></li>
              <li class="navbar-search hidden-sm">
                <input id="txt_dept_search" type="text" placeholder="Search..">
                <button id="btn_dept_search" class="btn-search"><i class="fa fa-search"></i></button>
              </li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
              <li class="dropdown notification warning">
                <a id='btn_add_dept' class="dropdown-toggle" data-toggle="dropdown">
                ...
                <div class="dropdown-menu">
                  <ul>
                    <li class="dropdown-header">Add New Department</li>
                  </ul>
                </div>
              </li>
        ...
        <div class="col-xs-12">
          <div class="card">
            ...
            <div class="card-body no-padding">
              <table id="tbl_dept_list" class="table table-bordered table-hover table-striped" cellspacing="0" width="100%" style="font: 90% Trebuchet MS; ">
                <thead>
                  <tr>
                    <th>Option</th>
                    <th>Dept Code</th>
